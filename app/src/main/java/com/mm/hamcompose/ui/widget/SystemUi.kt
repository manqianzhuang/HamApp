...
interface SystemUiController {
    fun setStatusBarColor(
        ...
        transformColorForLightContent: (Color) -> Color = BlackScrim
    )
 ...
 */
fun getLocalSysUiController(window: Window) = staticCompositionLocalOf {
    SystemUiController(window)
}

private val BlackScrim: (Color) -> Color = { original ->
    Color(0f, 0f, 0f, 0.2f).compositeOver(original)
}
